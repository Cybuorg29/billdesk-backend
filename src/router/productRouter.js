...
const { getProducts, getPublicProducts } = require('../controller/product');
...
router.get(`/get/user/products/:token`,getProducts)
router.post(`/add/stock`,addStock);
router.get('/get/products/:id',getPublicProducts)
